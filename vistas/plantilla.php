...
$infoWeb = CarritoComprasControladores::ctrMostrarInformacionWeb();
//echo '<prev class="bg-white">'; print_r($infoWeb); echo '</prev>';
...
<head>
    ...
    <title><?php echo $infoWeb['tiw_titulo']; ?></title>
    <link rel="stylesheet" href="<?php echo $infoWeb['tiw_dominio'];?>public/css/normalize.css">
    <link rel="stylesheet" href="<?php echo $infoWeb['tiw_dominio'];?>public/css/skeleton.css">
    <link rel="stylesheet" href="<?php echo $infoWeb['tiw_dominio'];?>public/css/custom.css">
</head>
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="four columns">
                <img src="<?php echo $infoWeb['tiw_dominio']. $infoWeb['tiw_img_logo'];; ?>" id="logo"  >
            </div>
            <div class="two columns u-pull-right">
                <ul>
                    <li class="submenu">
                            <img src="<?php echo $infoWeb['tiw_dominio']. $infoWeb['tiw_img_carrito'];; ?>" id="img-carrito">
                            <div id="carrito">
